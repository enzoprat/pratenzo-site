...
export default function sitemap() {
  ...
  const staticPages = [
    ...
    { url: `${SITE}/creation-site-internet-merignac`, priority: 0.8, changeFrequency: 'monthly' },
    { url: `${SITE}/creation-site-internet-pessac`, priority: 0.8, changeFrequency: 'monthly' },
    { url: `${SITE}/creation-site-internet-arcachon`, priority: 0.8, changeFrequency: 'monthly' },
    { url: `${SITE}/creation-site-internet-lege-cap-ferret`, priority: 0.75, changeFrequency: 'monthly' },
    { url: `${SITE}/creation-site-internet-ambares-et-lagrave`, priority: 0.75, changeFrequency: 'monthly' },
    { url: `${SITE}/creation-site-internet-marcheprime`, priority: 0.7, changeFrequency: 'monthly' },
    { url: `${SITE}/creation-site-internet-artigues-pres-bordeaux`, priority: 0.7, changeFrequency: 'monthly' },
    ...
    { url: `${SITE}/seo-bordeaux`, priority: 0.9, changeFrequency: 'monthly' },
